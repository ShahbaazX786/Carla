    ...
    <footer className='flex flex-col text-black-100 mt-5 border-t border-gray-100'>
      <div className="flex max-md:flex-col flex-wrap justify-between gap-5 sm:px-16 px-6 py-10">
        <div className="flex flex-col justify-start items-start gap-6">
          ...
          <p className='text-base text-gray-700'>Car la 2023 <br /> All Rights Reserved &copy;</p>
        </div>
      
        <div className="footer__links">
          {footerLinks.map((link)=>(<div key={link.title} className='footer__links'><h3 className='font-bold'>{link.title}</h3>
        ...
        <div className="flex justify-between items-center flex-wrap mt10 border-t border-gray-100 sm:px-16 px-6 py-10">
          <p>@2023 Car la, All Rights Reserved</p>
